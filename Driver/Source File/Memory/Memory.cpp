...
{
	DebugPrint("[+] Read Address: 0x%llX \n", Read_Address);
	...
	DebugPrint("[+] ProcessDirBase: 0x%llX \n", ProcessDirBase);
	...
	while (TotalSize)
	{
		...
		DebugPrint("[+] CurPhysicalAddress: 0x%llX \n", CurPhysicalAddress);
		...
		DebugPrint("[+] ReadPhysicalAddress: 0x%llX \n", NtRet);
...
{
	DebugPrint("[+] Write Address: 0x%llX \n", Write_Address);
	...
	while (TotalSize)
	{
		...
		DebugPrint("[+] WritePhysicalAddress: 0x%llX \n", NtRet);
